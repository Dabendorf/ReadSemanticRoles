...
if example_num <=6:
	column_name_map = {0: "head_id", 1: 'text', 6: "tree", 10: 'frame'}
else:
	column_name_map = {0: "head_id", 1: 'text', 6: "tree", 9: 'frame'}
...
for line in lines:
	...
	column_id_txt = columns[column_name_map_inv["head_id"]]
	if column_id_txt.isnumeric():
		column_id = int(column_id_txt)
	else:
		continue
	column_tree_id = int(columns[column_name_map_inv["tree"]])
